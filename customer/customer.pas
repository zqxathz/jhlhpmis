...
uses
  ...
  cxGridTableView, cxGridDBTableView, cxGrid, customerdm, cxContainer, Vcl.StdCtrls,
...
procedure TbplCustomerFrame.cxGrid1DBTableView1DataControllerDataChanged(Sender: TObject);
begin
