object shopperdatamod: Tshopperdatamod
  ...
  object sexfdmemtable: TFDMemTable
    ...
    Top = 64
    Content = {
      414442530F00EC380D010000FF00010001FF02FF0304001A0000007300650078
  ...
  object validateFdCommand: TFDCommand
    ...
    CommandText.Strings = (
        ...
        'select id from jhlh_pmis_shopper where phone=:phone and status=1' +
        ' and trash=0 limit 0,2')
    ParamData = <
      item
        Name = 'PHONE'
        ParamType = ptInput
