...
uses System.Classes,System.SysUtils,System.Hash,System.JSON,System.Net.HttpClientComponent,System.inifiles;
...
type
  ...
  protected
    ...
    function SendSMS(const AppKey, AppSecret, ReceiveNumber, FreeSignName, TemplateCode, TemplateContent: string;
      var ResultMsg: string): Boolean; overload;
...
function TAliDayu.SendSMS(const AppKey, AppSecret, ReceiveNumber, FreeSignName, TemplateCode, TemplateContent: string;
